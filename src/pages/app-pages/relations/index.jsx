            ...
            >
                <Link
                    ...
                    className={`text-gray-600/80 text-xs px-3 font-semibold flex gap-1 items-center mt-2 ${
                        isMenuItemCollapsed ? "hidden md:flex" : "flex"
                    }`}
                >
                    <ChevronLeft
                        strokeWidth={1.5}
                ...
                >
                    <form className="flex flex-col px-3 mt-4 gap-2">
                        <div className="flex flex-col text-xs text-gray-600">
                            <label htmlFor="relate-to-layer">
                                Relate to layer
                            </label>
                            <select
                                name="relate-to-layer"
                                className="mt-1 py-1 bg-white px-2 focus:outline-none rounded-sm md:rounded-[4px] border border-gray-300"
                            >
                ...
                <div className="w-full h-full flex">
                    ...
                    >
                        <Layer>
                            ...
                            {/* 15 to 1, 2, 3 */}
                            <Line
                                points={[590, 235, 700, 350]}
                                stroke="gray"
                                strokeWidth={2}
                                dash={[5, 5]}
                            />
                            <Line
                                points={[590, 235, 900, 350]}
                                stroke="gray"
                                strokeWidth={2}
                                dash={[5, 5]}
                            />
                            <Line
                                points={[590, 235, 800, 350]}
                                stroke="gray"
                                strokeWidth={2}
                                dash={[5, 5]}
                            />
                            ...
                            <Line
                                points={[600, 240, 430, 400]}
                                stroke="gray"
                                dash={[5, 5]}
                                strokeWidth={2}
                            />
                            <Line
                                points={[600, 240, 600, 450]}
                                stroke="gray"
                                dash={[5, 5]}
                                strokeWidth={2}
                            />
