...
const PointLink = ({ to, label, isCollapsed }) => {
    ...
    return (
        <Link
            title={label}
            className={`flex items-center justify-between hover:text-gray-500 hover:bg-blue-100 transition-colors  ${
                isCollapsed
                    ? "justify-center px-2 py-1.5"
                    : "justify-start px-4 py-1.5"
            }`}
        ...
        >
            ...
            >
                ...
                <span
                    ...
                    } font-semibold text-xs text-gray-800/80`}
                >
                    {label}
                </span>
            </div>
